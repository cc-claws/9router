...
/**
 * POST /api/oauth/xiaomi-desktop/api-key
...
export async function POST(request) {
  try {
    ...
    if (!validated) {
      ...
      console.log("[xiaomi-desktop] key validation failed, storing as untested");
    }
    ...
    console.log("Xiaomi Desktop API key import error:", error);
    return NextResponse.json(
